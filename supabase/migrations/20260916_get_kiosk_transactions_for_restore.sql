...
-- The kiosk receives an external-transaction snapshot that matches the
-- KioskOrder JSON shape so it can restore missing local orders safely.
                                    ...
                                    (
                                        select jsonb_agg(
                                            jsonb_build_object(
                                                ...
                                                'kitchenPrepared',
                                                    coalesce(tio.kitchen_prepared, false)
                                            )
